...
/**
 * 「薬剤マスタ一覧表」画面処理／表内部データ制御
 */

public class DispStockListMedMaster {
	 ...
	 * @return モデルの配列を返します。
	 */
	public StockListMedMasterMdl[] getTmpItem(StockListMedMasterMdl[] item,
		...
		StockListMedMasterMdl[] tmpItem = new StockListMedMasterMdl[item.length];
		// for(int i=0; i<numFlag.length; i++){
		// if(numFlag[i]){
	 ...
	 */
	public Vector getVdata(StockListMedMasterMdl[] tmpItem) {
