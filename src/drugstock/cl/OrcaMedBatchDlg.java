...
public class OrcaMedBatchDlg extends DefaultJDialog {
	...
	public OrcaMedBatchDlg(Frame frame, String title, boolean modal) {
	...
	private void jbInit() throws Exception {
		...
		titlePanel.setText("日レセ薬剤使用量取り込み【出庫作成】");
